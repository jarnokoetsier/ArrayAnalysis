...
<p><b>2. p-value and logFC histograms.</b> These plots show the distribution of p-values and logFCs.
Click for more information on the <a href = "https://arrayanalysis.org/explain/Phistogram" target="_blank">p-value histogram</a> 
and <a href = "https://arrayanalysis.org/explain/logFChistogram" target="_blank">logFC histogram</a> .</p>
<p><b>3. Volcano plot.</b> Scatter plot of logFC versus -log p-value. 
Click <a href = "https://arrayanalysis.org/explain/Volcanoplot" target="_blank">here</a> for more information on this figure.</p>
<p><b>4. MA plot.</b> Scatter plot of mean log expression versus logFC. 
Click <a href = "https://arrayanalysis.org/explain/MAplot" target="_blank">here</a> for more information on this figure.</p>
<p><b>5. Summary.</b> Get the number of differentially expressed genes for selected p-value and logFC thresholds.</p>
...
<ul>
<li>Applying a p-value and logFC threshold, or</li>
...
<p><b>3. Ranking variable 🔢</b> Specify which variable (logFC, -log P value, or signed -log P value) will be used to rank genes for the GSEA.</p>
...
as <code>Case - Control</code>.</p>
<p><b>2. Covariates ⚙️</b> Adjust for continuous (<i>e.g.</i>, age) and categorical (<i>e.g.</i>, sex, tissue) covariates.</p>
<p><b>3. logFC shrinkage 📉</b> Shrink imprecise logFCs towards 0 with the <a href = "https://doi.org/10.1093/bioinformatics/bty895" target="_blank">apeglm</a> method. 
This option is recommended to get more accurate logFCs estimates.</p>
