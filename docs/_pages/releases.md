...
<div class="row">
  <div class="col-sm-12 px-3">
	  <div class="jumbotron p-5 h-100" style="text-align: justify">
		  ...
		  <ul>
		  	<li>ORA and GSEA bug fixed</li>
	  		<li>Volcano plot label updated</li>
		  	<li>Gene annotation bug fixed</li>
		  	<li>Improved CEL file to sample ID matching</li>
		  </ul>
	  </div>
  </div>
</div>
...
<div class="row">
  <div class="col-sm-12 px-3">
	  <div class="jumbotron p-5 h-100" style="text-align: justify">
		  ...
		  <h1><b>Version 0.1.3</b></h1>
		  <ul>
		  	<li>Installation problems fixed</li>
	  		<li>.txt file format is accepted for count matrices and metadata</li>
